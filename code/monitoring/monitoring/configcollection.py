...
class CpdConfig(ConfigCollection):
    ...
    def parse(self, cfg):
        ...
        conf.append('--files')
        conf.append('system_to_investigate_catena/')
...
class PmdConfig(ConfigCollection):
    ...
    def parse(self, cfg):
        ...
        conf.append('-d')
        conf.append('system_to_imvestigate_prevayler/')
...
class CatenaConfig(ConfigCollection):
    ...
    def __init__(self):
        super().__init__('catena.jar', 'catena_a.jar')
...
class SunflowConfig(ConfigCollection):
    ...
    def __init__(self):
        super().__init__('sunflow.jar', 'sunflow_a.jar')
        self.wl = ['128']
